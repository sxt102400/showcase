...
public class ModelClient {
     ...
     * @return
     */
    public Map queryModelAll(String processDefId) {
        ProcessDefinition processDef = repositoryService.createProcessDefinitionQuery().processDefinitionId(processDefId).singleResult();
        BpmnModel bpmnModel = repositoryService.getBpmnModel(processDefId);
        List<Process> processes = bpmnModel.getProcesses();
     ...
     * @return
     */
    public Map getCurrNode(String processDefId, String processId,String flowElementId, Map<String, Object> variables) {
    ...
    public void getNextNode(String processDefId, String taskDefKey, Map<String, Object> map) {
